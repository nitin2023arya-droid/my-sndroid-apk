...
function resolveLedgerParticular(e) {
    // ⚠️ This function is unchanged – your accounting logic stays intact.
    const metal = e.metal || '';
    ...
    if (Capacitor.isNativePlatform()) {
        try {
            ...
            const result = await Filesystem.writeFile({
                ...
                // No encoding needed for binary data – base64 string is auto‑detected
            });
            
            // Share the file via native share sheet
            await Share.share({
                title: 'Account Statement',
                text: 'Your PDF statement is ready',
                url: result.uri,
                dialogTitle: 'Share PDF',
            });
            
            alert('PDF saved and shared successfully!');
        } catch (error) {
...
// Helper to convert Blob to base64 string (without the data:application/pdf;base64, prefix)
